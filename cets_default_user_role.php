...
class cets_default_user_role 
{
   ...
   //Add the site-wide administrator menu  
	function add_siteadmin_page(){
       ...
       add_submenu_page('wpmu-admin.php', 'New User Default Role', 'New User Default role', 10, 'cets_default_role_management_page', array(&$this, 'cets_default_role_management_page'));
